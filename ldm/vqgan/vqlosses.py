...
from ..autoencoderkl.discriminator import NLayerDiscriminator, weights_init
...
class VQLPIPSWithDiscriminator(nn.Module):
    ...
    def forward(
        self, codebook_loss, inputs, reconstructions, optimizer_idx, global_step, last_layer=None, cond=None, split="train"
    ):
